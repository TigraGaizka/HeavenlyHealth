...
<html>
<head>
    <title> News | Heavenly Health </title>
...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item active"><a href="<?php echo base_url('index.php/home/news') ?>" class="nav-link">News</a></li>
	 ...
	 <img src="<?php echo base_url(); ?>assets/images/bg_5.jpg" class="img-fluid" alt="Responsive image">
    ...
    <div class="row justify-content-center mb-4">
      <div class="col-md-10 text-center">
        <h1 data-aos="fade-up" class="mb-3"> Latest News </h1>
      </div>
    </div>
        ...
        <div class="row d-flex">
          ...
          <div class="col-md-4 d-flex">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20 rounded" style="background-image: url('<?php echo base_url(); ?>assets/images/<?= $row->picture ?>');">
              </a>
              <div class="text mt-3">
                <div class="meta mb-2">
                  <div><a href="#"><?= $row->date ?></a></div>
                  <div><a href="#" class="meta-chat"><span class="fa fa-eye"></span> <?= $row->views ?> </a></div>
                </div>
