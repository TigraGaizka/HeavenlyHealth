...
<html>
<head>
    <title> Doctors | Heavenly Health </title>
      ...
      <div class="container">
        <div class="row justify-content-center pb-5 mb-3">
          <div class="col-md-7 heading-section text-center">
            <h1> Our Doctors </h1>
            <p data-aos="fade-up" data-aos-delay="100"><a href="<?php echo base_url('index.php/admin/managedoctors') ?>" class="btn btn-primary btn-pill">Manage</a></p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="staff">
              ...
              <div class="text pt-3 px-3 pb-4 text-center">
                <h3><?= $row->name ?></h3>
                <span class="position mb-2"><?= $row->expertise ?></span>
                <div class="faded">
                  <p><?= $row->profile ?>.</p>
