...
<html>
<head>
    <title> Manage Doctors | Heavenly Health </title>
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item active"><a href="<?php echo base_url('index.php/admin/doctors') ?>" class="nav-link">Doctors</a></li>
	 ...
	 <img src="<?php echo base_url(); ?>assets/images/bg_7.jpg" class="img-fluid" alt="Responsive image">
  ...
  <section class="site-section">
      <div class="container">
          <div class="row justify-content-center pb-5 mb-3">
            <div class="col-md-7 heading-section text-center">
              <h1> Doctors List </h1>
              <span class="subheading">MANAGE DOCTORS</span>
          </div>
      </div>
     ...
     <table class="table">
        ...
        <tr>
          ...
          <td><?= $row->profile ?></td>
          <td><?= $row->photo ?></td>
          <td width="20px"><a href="<?php echo base_url(); ?>index.php/admin/editd/<?= $row->id ?>"><input type="submit" value="Edit" class="btn btn-info"></td>
          <td width="20px"><a href="<?php echo base_url(); ?>index.php/admin/removeDoctors/<?= $row->id ?>"><input type="submit" value="Delete" class="btn btn-danger"></a></td>
        </tr>
        </tbody>
        <?php endforeach ?>
        <tbody>
          <td colspan="8" align="right"> <a href="<?php echo base_url(); ?>index.php/admin/addd"><input type="submit" value="Add" class="btn btn-primary"></a> </td>
        </tbody>
    </table> 
    </div>
  </section>
