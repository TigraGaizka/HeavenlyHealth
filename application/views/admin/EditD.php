...
<html>
<head>
    <title> Edit Doctors | Heavenly Health </title>
      ...
      <div class="container">
          <div class="row justify-content-center pb-5 mb-3">
            <div class="col-md-7 heading-section text-center">
              <h1> Edit Doctors </h1>
              <span class="subheading">CHANGE DESIRED DATA</span>
          </div>
      </div>

      <?php foreach ($doctors as $row): ?> 
       <form method="POST" action="<?php echo base_url('index.php/admin/editDoctors/<?= $row->id ?>') ?>" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" name="expertise" class="form-control" id="expertise" value="<?= $row->expertise ?>">
        </div>
        <div class="form-group">
          <label>Profile</label>
          <input type="text" name="profile" class="form-control" id="profile" value="<?= $row->profile ?>">
        </div>
        <div class="form-group">
          <label>Image</label>
