	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item active"><a href="<?php echo base_url('index.php/admin/messages') ?>" class="nav-link">Messages</a></li>
	        </ul>
	      </div>
	    </div>
	 </nav>
	    ...
	    <div class="container">
		 ...
		 <table class="table">
		    ...
		    <tr>
		      ...
		      <td><?= $row->email ?></td>
		      <td><?= $row->subject ?></td>
		      <td width="20px"><a href="<?php echo base_url(); ?>index.php/admin/checkm/<?= $row->id ?>"><input type="submit" value="Check" class="btn btn-primary"></td>
