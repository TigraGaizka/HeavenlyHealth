...
<html>
<head>
    <title> Edit News | Heavenly Health </title>
...
<body>
	...
	<section class="site-section">
     ...
     <?php foreach ($news as $row): ?> 
       <form method="POST" action="<?php echo base_url('index.php/admin/editNews/<?= $row->id ?>') ?>" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <label>Views</label>
          <input type="text" name="views" class="form-control" id="views" value="<?= $row->views ?>">
        </div>
        <div class="form-group">
          <label>Image</label>
